...
# Add treatment concentration to fatty acid view
merged_fatty_acid <- merge(x = colData(mae_sub[[1]]), y = colData(mae)[c("animal", "Treatment concentration")], all.x = TRUE, by = "animal")
