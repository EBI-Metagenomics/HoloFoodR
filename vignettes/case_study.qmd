...
and then use centered log-ratio method to tackle the compositional data (see A field guide for the compositional analysis of any-omics data).
...
of 0.2%, only bacteria species remain.
...
We can measure alpha-diversity of the microbiome experiment. This type of
diversity is within the same sample.
