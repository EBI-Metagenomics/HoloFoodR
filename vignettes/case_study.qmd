...
We need to add a few columns for the subsequent data analys steps. For instance,
...
# Add treatment_group to colData(mae_day_60) that was removed for MOFA
# analysis
...
When using stacked approach or metabolites.
