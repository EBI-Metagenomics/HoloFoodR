...
altExp(mae_sub[[2]], "prev_genus") <- subsetByPrevalentFeatures(mae_sub[[2]],
                                                                prevalence = 0.2,
                                                                detection = 0.01,
                                                                rank = "Genus")

agglomerateByRank(altExp(mae_sub[[2]], "prev_genus"), rank = "Genus")
