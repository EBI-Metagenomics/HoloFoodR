...
# Add treatment concentration and to fatty acid view
...
# Add treatment group categories (Tiger Control vs. others)
colData(mae_sub)["treatment_group"] <- ifelse(colData(mae_sub)[["treatment_concentration"]] == 0,
                           "control", "treatment")
