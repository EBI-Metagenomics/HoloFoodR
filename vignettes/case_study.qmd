...
```{r}
# Standartize colData of metagenomic data
#  names(colData(altExp(mae_sub[[2]], "prev_genus"))) <-
#   colData(altExp(mae_sub[[2]], "prev_genus")) |> names() |> tolower()
# 
# names(colData(altExp(mae_sub[[2]], "prev_genus"))) <- 
#   
...
tse_pcoa <- runMDS(tse, "prev_genus"),
                   FUN = vegan::vegdist,
                   methods = "bray",
                   assay.type = "relabundance",
                   name = "MDS_bray")
