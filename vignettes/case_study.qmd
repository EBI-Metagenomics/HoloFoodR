...
colData(altExp(mae_sub[[2]], "prev_genus"))["Treatment concentration"] <- ifelse(
...
set.seed(42)
# x <- aldex.clr(assay(aldex_data), aldex_data$`Treatment concentration`) # No significantly differentially abundant species
