...
# Sort prevalences in decreasing order
...
custom_plotter("fatty_acids_mg", factor = 1)
custom_plotter("metagenomic_amplicon", factor = 2)
custom_plotter("metagenomic_amplicon", factor = 3)
```
