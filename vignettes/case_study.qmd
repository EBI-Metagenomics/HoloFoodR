...
packages <- c(
    "ggplot2", "knitr", "mia", "dplyr", "miaViz", "MOFA2",  "patchwork", "reticulate", "MGnifyR", "reshape2", "GGally"
    )
...
most_prevalent_genera <- most_prevalent_genera[grepl("^Genus:", most_prevalent_genera)]
...
treatment_grops <- colData(mae_sub)[, "Treatment code"] |> unique()
```
...
# Add trial.timepoint for longitudinal machine learning
