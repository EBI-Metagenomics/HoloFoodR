...
mae_day_60 <- altExp(mae_sub[[2]])[, colData(mae[[2]])$trial.timepoint == 60]

# Select only the columns we require
colData(mae_day_60) <- colData(mae_day_60)[ , c("treatment_code", "mass_category"), drop = FALSE]
...
```
Factor 3 is similar to factor 2 but the variance explained numbers are slightly
lower.
