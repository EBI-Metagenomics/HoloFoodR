...
fatty_acid_mg_assay <- assay(salmon_merged_mae[["FATTY ACIDS MG"]], "counts")
...
assay(salmon_merged_mae[["FATTY ACIDS MG"]], "counts") <- fatty_acid_mg_assay
```
...
```{r}
colData(salmon_merged_mae) <- colData(salmon_merged_mae)[, names(colData(salmon_merged_mae)) %in% c("animal", "Treatment code")]
